<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"E:\phpstudy_pro\WWW\tpframe/admin/user\view\\role_add.html";i:1577689778;s:57:"E:\phpstudy_pro\WWW\tpframe\admin\common\view\header.html";i:1577691051;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <div class="body-content">
            <form method="post" class="form-x" action="<?php echo url('user/Admin/save'); ?>" onsubmit="return submitForm();">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <textarea name="action_list" class="input" style="height:90px;"></textarea>
                        <div class="tips"></div>
                    </div>
                </div>
